...
import { Combobox, Transition, ComboboxOption, ComboboxOptions, ComboboxButton, ComboboxInput } from "@headlessui/react";
              ...
              {filteredManufacturers.length === 0 && query !== "" ? (
                ...
                filteredManufacturers.map((item) => (
                  <ComboboxOption
                    key={item}
                    className={({ active }) =>
                      `relative search-manufacturer__option cursor-default select-none py-2 pl-3 pr-9 ${
